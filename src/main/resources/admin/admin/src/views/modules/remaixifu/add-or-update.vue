	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="衣门襟" prop="yimenjin">
					<el-input v-model="ruleForm.yimenjin" placeholder="衣门襟" clearable  :readonly="ro.yimenjin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="衣门襟" prop="yimenjin">
					<el-input v-model="ruleForm.yimenjin" placeholder="衣门襟" readonly></el-input>
				</el-form-item>
